  	...
  	<div class="row">
  		<div class="col-sm-4 d-flex align-items-stretch">
			  ...
			  <div class="card-body">
			    ...
			    <p class="card-text">Lemon Garlic Herb Salmon is a deliciously easy salmon recipe, so simple to make, yet so delicious! Crispy on the outside, soft and tender on the inside!</p>
			  </div>
			</div>
  		</div>
  		<!-- ******** -->
  		 <div class="col-sm-8 d-flex align-items-stretch ">
			  ...
			  <div class="card">
			    ...
			    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
			      <div class="card-body">
			        <li>28 ounces (800g) skinless salmon fillets</li>
			    ...
			    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
			      <div class="card-body">
			       <h4>How To Make It:</h4>
				     <h5>Step 1</h5>
					<p>Pat dry room temperature salmon filets with paper towel. Season all over with salt, pepper. Squeeze 1-2 teaspoons of lemon juice over each filet, and rub all the flavour in.</p>
					<h5>Step 2</h5>
					<p>Heat the olive in a large non-stick pan or skillet over medium-high heat until hot. Place salmon filets flesh side down, pressing them lightly so the entire surface of the flesh comes into contact with the pan. Sear, undisturbed, for 3-4 minutes until crispy and golden.</p>
					<h5>Step 3</h5>    
					<p>Flip and sear the other side of each filet for TWO minutes. Add in the butter, chopped garlic, 3 tablespoons of parsley, remaining lemon juice and lemon slices.  Stir the butter and garlic around each filet.</p>
					<h5>Step 4</h5>    
					<p>Continue to cook the salmon for a further 1-2 minutes, or until salmon reaches desired doneness. (The butter will begin to brown slightly.) Taste test and season with salt and pepper to your tastes, and add more lemon juice if desired.</p>
					<h5>Step 5</h5>    
					<p>Garnish with the remaining parsley and drizzle the butter over each fillet.</p>
			      </div>
			    </div>
			  </div>
			</div>
